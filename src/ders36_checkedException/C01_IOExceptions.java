...
public class C01_IOExceptions {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        /*
           ...
           java compile time orada bir hata ihtimali gorur
           ve altini kirmizi olarak cizer

           bu durumda kirmizi cizgiyi kaldirmak icin 2 yontem vardir;
            1- exception'i try-catch blogu ile handle etmek
            2- javaya sorun ihtimalinin farkinda oldugumuzu ama kodumuza guvendigmizi
               ve calismaya devam etmesini istedigimizi soylemek
               bunun icin method signature'na method deklerasyonu ile curly braces arasina
