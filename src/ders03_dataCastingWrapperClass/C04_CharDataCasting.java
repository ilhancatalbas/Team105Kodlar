...
public class C04_CharDataCasting {
    ...
    public static void main(String[] args) {
        ...
        // char data turundeki herbir karakterin sayisal bir karsiligi var
        ...
        // char data turleri matematiksel islem gorunce mesela + (arti)  - (eksi) vb hemen kendisini matematik gibi yapiyor
